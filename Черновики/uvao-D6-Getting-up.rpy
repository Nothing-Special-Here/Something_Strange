...
#                nvl clear
        ...
        th "Интересно, кто её проводил, если вожатка здесь была? Может быть, Славя? Ей не впервой."
        ...
        "Поёжившись от малоприятной перспективы, я наконец направился к выходу."
        menu:
            "Пойти на завтрак":
                pass
                #TODO текст
