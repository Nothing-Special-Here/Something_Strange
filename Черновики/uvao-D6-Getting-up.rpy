...
label alt_day6_uvao_morning_aidpost:
    ...
    "Голос захохотал, видимо донельзя довольный собственной шуткой, но тут же резко оборвал сам себя."
    ...
    "Рядом плакат со схематичным  изображением какого-то создания, самого что ни на есть гуманоидного вида. А это-то здесь для чего? Какие-то безумные эксперименты доктора Коллайдер? Что вы скрываете, Виолетта Церновна?"
    "Блуждая по комнате, мои глаза наконец остановились на таблице Сивцева по-научному, а в просторечии просто таблицы для проверки зрения. Что-то в ней не так…"
