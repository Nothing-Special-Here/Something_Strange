...
#                nvl clear
        ...
        "Я с недоверием посмотрел на вожатую. Юля по-прежнему определённо не казалась мне опасной. Она живая и теплая. Она веселая и с ней интересно."
        "А что до Шурика... Положим, я-то совершенно точно знал, что именно с ним случилось."
        th "Но этот псих сам виноват, нефиг было лезть куда не надо, да на меня бросаться. Да и мозги у него явно  были набекрень ещё до встречи с Юлей - может, её попытка отпугнуть попросту стала для него последней каплей?"
        ...
        "Возможно, мне было бы проще понять то, о чём говорила Ольга, если бы не кузнечные молоты, беспощадно долбившие в виски."
        ...
        "Ольга, терпеливо ожидающая моей реакции, восприняла молчание по-своему."
        ...
        # сцена - домик ОД снаружи утром
        "Наскоро поплескав в лицо ледяной водой и мимолётно порадовавшись тому, что на умывальниках давно уже никого нет, а значит и нет риска быть облитым, я забросил полотенце в домик и в нерешительности притормозил на крыльце."
        menu:
            "Пойти на завтрак":
                pass
                #TODO текст
        ...
        "Хихикнул голос у меня в голове."
        me "А я-то за что ?"
        ...
        "И в голове снова залились ехидным смехом."
        ...
        mt "Ты ведь знаешь, что пионерам запрещено покидать территорию лагеря без сопровождения взрослых."
...
label alt_day6_uvao_morning_aidpost:
    ...
    # ЛБ: Томограф, кмк, в 1989г. можно было бы найти в Москве, в Ленинграде, м.б. ещё в Новосибирске каком-нибудь и _некоторых_ республиканских столицах. Причём томограф рентгеновский, не МЯР...
    ...
    cs "Что-нибудь ещё?"
#ЛБ: дальше всё переписать на корню. Никаких схождений с ума!
