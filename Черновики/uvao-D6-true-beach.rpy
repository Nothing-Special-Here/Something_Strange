...
# Пляж в Д3-волейбол гарантированно не посещали, плавок у ГГ нет - проверено. (ЛБ)
    ...
    if alt_day2_date == 3: # ЛБ: ...но гипотетически можем в Д2 вечер провести с Алисой на пляже (если dv_lp > 3), тогда утром Д3 получим плавки у вожатой. На выходе с пляжа имеем dv_lp>=5 - можем и пройти на UVAO
        th "Вернее, есть, но благополучно лежат в моём домике, в тумбочке. По такой жаре за ними тащиться через весь лагерь? Увольте."
    ...
    show sl smile2 swim close at left with dissolve
...
# возможно, побольше комментариев Шизы про Мику! -ЛБ
    ...
    show mt rage panama swim far at fright
    ...
    show mt angry panama swim far at fright
    show us dontlike swim far at cright
    with dissolve
    ...
    show mt surprise panama swim far at fright
