...
label alt_day6_true_beach:
    ...
    if alt_day2_date == 3:   # замутили было с Алисой, искупались в Д2 и бегали потом в семейниках по лагерю
        dreamgirl "Так вот, отправляйся-ка ты на пляж. Уже шестой день тут болтаешься, погода всё время стоит отличная, а искупаться толком так ни разу и не удалось."
        dreamgirl "Полагаю, тот удручающий эпизод, когда тебя Алиса чуть не утопила, можно не считать?{w} Ты тогда ещё в семейниках по лагерю бегал - это если ты запамятовал."
    else:
