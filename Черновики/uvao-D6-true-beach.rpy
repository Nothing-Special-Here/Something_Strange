...
label alt_day6_true_beach:
    ...
    show sh smile pioneer far at cleft with dissolve
    ...
    show mt normal swim panama far at center with dissolve
...
# Пляж в Д3-волейбол гарантированно не посещали, плавок у ГГ нет - проверено. (ЛБ)
    ...
    me "Ольга Дмитриевна…"
    show mt normal swim panama with dissolve
    ...
    show mt surprise swim panama with dspr
    ...
    show mt normal swim panama close with dspr
    ...
    show mt surprise swim panama close with dspr
    ...
    show mt smile swim panama close with dspr
    ...
    show mt laugh swim panama close with dspr
    ...
    show mt grin swim panama close with dspr
    ...
    show mi smile swim at cright with dissolve
...
# возможно, побольше комментариев Шизы про Мику! -ЛБ
    ...
    th "Нет-нет, никаких полотенец. Тело моё свежо, разум мой расслаблен… Тьфу ты! Наоборот. Тело моё расслаблено, разум свеж. Речные волны…"
    ...
    show mt rage swim panama far at fright
    show us dontlike swim far at cright
    show sl normal swim close at left
    with dissolve
    ...
    show mt angry swim panama far at fright
    show us dontlike swim far at cright
    with dissolve
    ...
    show mt surprise swim panama far at fright
    ...
    #jump куда-то, надо будет баббл глянуть.