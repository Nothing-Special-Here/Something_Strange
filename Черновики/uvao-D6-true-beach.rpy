...
label alt_day6_true_beach:
    ...
    if alt_day2_date == 3:   # замутили было с Алисой, искупались в Д2 и бегали потом в семейниках по лагерю
        ...
        dreamgirl "Полагаю, тот удручающий эпизод, когда тебя Алиса чуть не утопила, можно не считать?{w} Ты тогда ещё в семейниках по лагерю бегал - это если запамятовал вдруг."
    else:
    ...
    if alt_day2_mi_rejected: #В Д2 закрутили было с Мику, но на пляже вечером ушли в отказ
        "Вернее, про Мику-то я кое-что узнать успел, но..."
...
# возможно, побольше комментариев Шизы про Мику! -ЛБ
    ...
    if not alt_day1_sl_conv: #Уточнить по флагам. Кажется, до пристани Дрищ в Д1 уже не доходит
