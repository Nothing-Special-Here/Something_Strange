...
# /пока что задаём сцену на время отладки
    ...
    if not alt_uvao_D6_left_MI_talk:
        ...
        th "Так я-то по делу разбежался. {w}Впрочем, плевать, куда они все делись. Где мне Лену-то искать?"
    ...
    me "Что?! Но..."
    # ЛБ: кажется, дальше повтор фразы с утренним медпунктом. Прояснить и устранить
