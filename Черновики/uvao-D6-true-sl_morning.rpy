...
label alt_day6_true_sl_morning:
    ...
    if alt_uvao_D5_evening_sl:
        ...
        th "Но то, что она мне вдруг точную дату решила сообщить ни с того ни с сего, а потом ещё эти странные разговоры про мечты, которые можно здесь исполнить и всё такое… Это вот очень и очень странно."
    else:
    ...
    if alt_uvao_D5_evening_sl:
        ...
        sl "Тысяча девятьсот восемьдесят девятый. Сегодня двадцать третье июля."
