...
#
    ...
    th "По крайней мере, лучше поговорить здесь, чем наедине в медпункте."
...
#    cs "Догадливый. То, что представилось тебе Юлей, одно из проявлений точки прокола. Визуализация, можно сказать. Вы ведь с ней договорились где-то встретится, правильно?"
    ...
    cs "У тебя ведь есть фотокамера в смарт-фоне?"
    ...
    cs "А почему нет? Думаю, для {i}тебя{/i} она должна быть безопасна, если специально злить не будешь.{w} Только хочу сразу предупредить насчёт чересчур близких контактов — тут тебе изделие №2 не поможет."
    "Я снова покраснел."
