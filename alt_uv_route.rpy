...
#    play sound sfx_angry_ulyana
    ...
    "Нужный стеллаж."
    "«Природоведение»… Не то.{w} «Гометрия»… К чёрту геометрию!"
    "«История»! Есть!"
    ...
    # TODO: сюда вколхозить ЦГ - слепить из d6_pioneer и day4_us_morning
    ...
    "Лена промолчала."
    "Шаги девочек удалялись. Лирическая литература была в дальней секции, посему…"
