...
#    stop sound_loop fadeout 1
    ...
    dreamgirl "Интуиция здесь ни при чём, здесь аналитику надо задействовать. Так что постарайся сам подумать."
...
label alt_day5_uvao_ev_beach_event_direct:
    ...
    sl "Вряд ли…"
    "Да, так и есть. Наверное, сейчас стоит встать и уйти…{w} Да, вот сейчас…{w} Сейчас встану, извинюсь и пойду… "
