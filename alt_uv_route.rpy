...
label uvao_D4_meet_Yulia_at_evening:
    ...
    show uv smile close at center with dspr
    uv "Там старый лагерь, за лесом. По тропинке идти надо, тогда придешь."
    me "А ког…"
    ...
    if (uvao_D4_supper_cs):
        ...
        menu:
            "Пора навестить доктора Виолу.":
                ...
                me "Встретил снова Юлю, покормил булками, немного поболтали.{w} Я так понял, что она в каком-то старом лагере живет."
                "Виола кивнула."
