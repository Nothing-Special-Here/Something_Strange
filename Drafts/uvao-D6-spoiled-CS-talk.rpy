...
#последовательно сменяют друг друга сцены утренних медпункта снаружи, дорожки между домиками, столовой издали.
    ...
    "Продолжала Виола, сворачивая в сторону от площади, на которой зарядка сменилась линейкой, судя по доносившемуся оттуда бодрому \"бу-бу-бу\"."
...
#    "Виола остановилась и кивнула на стайку детей, с жизнерадостным гиканьем несущихся куда-то через площадь."
    ...
    if alt_uvao_D5_hentai:
        th "Вряд ли она меня хочет потроллить. {w}Да и чего мне стесняться-то? Что я, в самом деле, маленький что ли?"
    ...
    menu:
        "Пусть даже так.":
            ...
            dreamgirl "Это не мир вокруг ненатурально яркий. {w}Он совершенно обычный. {w}Он был точно таким же во времена твоего детства, вспомни, ну же, давай!"
            dreamgirl "Просто со временем ты разучился на него смотреть, ты попросту забыл, как это делать."
