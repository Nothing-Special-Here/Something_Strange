...
label alt_day6_uvao_spoiled_CS_talk
    ...
    "Она не глядя махнула рукой в сторону кушетки."
    show cs normal glasses with dissolve
    "Присев, я от нечего делать стал рассматривать кабинет. Раньше как-то не складывалось."
    "Весы, шкаф с лекарствами, пара кушеток, ничего необычного. На стене плакат с бодрой надписью, призывающей разводить овощи. Зачем он здесь?"
    ...
    "Впрочем, прежде чем я успел заскучать окончательно, Виолетта закончила писать и повернулась ко мне."
    ...
    "Вопреки моим опасениям, Виола кивнула как ни в чём не бывало и молча достала из ящика стола \"цитрамон\"."
...
#последовательно сменяют друг друга сцены утренних медпункта снаружи, дорожки между домиками, столовой издали.
    ...
    cs "Мы ведь с тобой {i}оба{/i} взрослые люди, практически ровесники, правда?"
...
#    "Виола остановилась и кивнула на стайку детей, с жизнерадостным гиканьем несущихся куда-то через площадь."
    ...
    if alt_uvao_D5_evening_sl:
        ...
        cs "Ничто не может продолжатьmся бесконечно, и пребывание в этом лагере - не исключение."
    else:
