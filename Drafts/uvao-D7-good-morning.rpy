...
#   else:
    ...
    if (alt_uvao_D6_Zippo = 1): #видели зажигалку в Д6 после обеда с Алисой. тру (ГГ-герой).
        ...
        if alt_uvao_D6_left_MI_talk: #через левый медпункт
            ...
            me "Даже будь на мне все семь смертных грехов - реши ты рассказать об этом правдиво, сейчас тебе всё равно не поверили бы."
            "Девушка ничего не ответила, разом поникнув. Кажется, до неё дошло - или хотя бы буду надеяться на это."
            ...
            me "Осталось лишь понять, зачем {i}мне{/i} это нужно. Что я получу взамен?"
        ...
        "Решительно пресёк я все попытки снарядить меня на помощь японочке и, не дожидась ответа, под локоток оттащид Ольгу в сторонку."
        #mt удивлённая close, mi убираем вбок
        ...
        mt "Отдавай, ладно, но только чтобы я эту зажигалку больше не видела!"
    ...
    elseif (alt_uvao_D6_Zippo = 2): #видели зажигалку в Д6 после озера. (фальш-ГГ).
        ...
        dv "Запомни, новичок, я жду до обеда. Смотри, не опоздай."
        me "Ты же говорила - до отъезда…"
        dv "А теперь - до обеда. Раньше надо было соглашаться!"
    ...
    "Прежде, чем я успел что-нибудь ответить, дверь распахнулась, и в домик ворвался какой-то смутно знакомый пионер - кажется, я видел его в лагере пару раз за эти дни."
    pi "Ты Семён?"
