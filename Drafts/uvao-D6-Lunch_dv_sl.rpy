    ...
    menu:
        "Сесть с Алисой":
            ...
            if alt_uvao_true:
                ...
                #пришли на обед с хозработ
                # sl "я-то думала, мы пообедаем вместе..." обижается
                # th "как неловко вышло"
            ...
            if alt_uvao_true:
                "Тут я испуганно прикусил язык - а ну как и впрямь заставит подметать? Зубной щёткой? {w}Но Славя лишь рассмеялась."
            else:
            ...
            th "Времени всего день остался до отъезда, проведу хоть его по-человечески, с удовольствием!"
            if alt_uvao_true:
