...
label alt_day6_uvao_prufung_sl:
    ...
    # ЛБ: появились новые персонажи - пионеры со спрайтами - al, dn и tn. У каждого одна-три позы и несколько эмоций.
...
# ЛБ: Есть мнение, что где-то здесь Славяна сломается и потечёт, как воск. Это ведь не к фашистам на расстрел, это Творец-режиссёр отправил к остальным марионеткам, чтобы не путалась под ногами, так что всё пропало, и жалкий(!) конец уже близок
    ...
    me "Лучше не…"
    uv "Можно."
    th "Да что она делает такое? И Мику тоже, увидела девочку с кошачьими ушами - и как будто так и надо! Где удивление, где паника, в конце концов?" 
    ...
    mi "Ой, спасибо, я так рада! Так жаль, что я тебя не видела, я бы что-нибудь спела специально для тебя! Знаешь, что? Я вас приглашаю на следующий концерт, правда, я ещё не знаю, когда он будет, но как узнаю, я вам обязательно напишу!"
    mi "Только мне надо записать ваши адреса, а то куда же я буду присылать письма с билетами? Правда, у меня сейчас некуда записать, но я запомню, у меня очень хорошая память, почти что фотографическая! Куда тебе писать, Сёмочка, говори?"
    ...
    # ЛБ: или ныкаемся от Лены, та уходит. Юля не возвращается, однако после нэкомассажа настроение улучшилось - не настолько, чтобы идти на танцы, но сидеть на пристани больше незачем. Крадёмся к домику с целью спокойно переждать до отбоя. Настигнуты Леной на шезлонгах - судьба!
