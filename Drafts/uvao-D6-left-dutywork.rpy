...
#ЛБ: здесь ГГ начинает терзаться мыслями о Юле и воспоминаниями об утреннем разговоре с ВЦ и терзается вплоть до внезапной реплики Шизы.
    ...
    # сцена где-то по дороге к складу, уточнить по карте. Вероятно, площадь
    ...
    #blink, сцена та же, прячем Славю.
    ...
    "Не самое интересно занятие, конечно, но с другой строны - работа была не бей лежачего, что называется."
...
#ЛБ: TODO возможно, здесь надо больше букв про приятность полезности. Подсмотреть у Автора.
    ...
    me "Знала бы она, что я тогда про неё думал... {w}Хорошо всё-таки, что телепатии не существует - иначе сраму бы не обобрался."
    "В последнем тюке оказываются выстиранные личные вещи отыхающих - всякие там штаны-рубашки."
    ...
    th "А хотя, что здесь такого? Поработаю ещё немного на пользу общества. Социализация, опять же..."
...
#ЛБ: нужна проверка спрайтов, сцен и проч.
    ...
    sl "А я равзе не сказала? Мы с тобой в клуб идём. Серёжа нас уже, наверное, заждался."
    me "Сыроежкин?"
    ...
    window show
    "В этот раз Мику сидела не под роялем, а за ним, наигрывая какую-то мелодию."
    ...
    if alt_day2_club_join_musc:
        ...
        mi "Сёма, ты ведь записывался в музкружок, а не участвуешь ни в одном номере. И даже ни разу не зашёл на одну репетицию. Не стыдно тебе?"
        "Я пожал плечами."
        me "Да не особенно…"
    ...
    "Мы занесли проклятый ящик по ступенькам, по пути чуть не уронив, и с облегчением поставили на дощатый пол сцены."
    ...
    "И знаешь, я тебя хотела спросить..."
    ...
    #горн
    "Улыбнувшись мне напоследок, Славя легко спрыгнула со сцены и, помахав рукой, заспешила в сторону столовой."
    "Проводив её взглядом, я сполз на землю и поплёлся следом."
