...
# Используется флаг alt_day3_dancing партнёрши по танцам в Д3 (ЛБ: сейчас не работает - при сычевании второго танца (выход на ЮВАО) всегда выставляется alt_day3_dancing = 5, и мы ничего не знаем про первый танец. Печаль-беда, перед релизом надо будет договариваться с Автором# Используется индикатор степени настойчивости Слави alt_uvao_D6_sl_assert
#
