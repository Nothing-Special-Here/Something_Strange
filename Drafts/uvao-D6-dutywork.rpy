...
label alt_day6_uvao_duty:
    ...
    #REMOVE THIS!
    window show
    "Надо, наверное, Юлю навестить. Или лучше всё-таки сходить после обеда? И сделать это надо как можно незаметнее. А то мне как будто сегодняшней взбучки мало. Кроме того, в обед булочки будут. А я как раз Юле обещал. Не идти же с пустыми руками." #ЛБ: возможно, разбить этот и следующий блоки на несколько мелких реплик? Или хоть через {w}
    ...
    "Чего-чего, а логического мышления у Шизы не отнять." м
    dreamgirl "А то!"
    ...
    "Я не обратил внимания на кривлянье Шизы. Не до того сейчас." #ЛБ: надо "Шизу" замаскировать
    ...
    "Ожидаемо хохотнула Шиза." #ЛБ: надо "Шизу" замаскировать
    ...
    mt "И чтобы сегодня к вечеру всё было готово!" # ЛБ: Скорее, к полднику? Концерт после/вместо полдника, а вечером дискотека
    show el laugh pioneer far at right with dspr
    el "Конечно, конечно, Ольга Дмитриевна."
    "Затараторил кибернетик."
    el "К вечеру всё будет готово, не беспокойтесь." #ЛБ: см. выше
    ...
    th "Я лично позволил бы. Мне совсем не улыбается таскать здоровенные колонки и усилители по всему лагерю."
    dreamgirl "Эх ты, джентльмен…"
    th "А ещё лучше я бы нагрузил все эти тяжести на Шурика."
    dreamgirl "А вот это уже хорошая идея!"
    "Хихикнула Шиза." #ЛБ: надо "Шизу" замаскировать
    th "Но неосуществимая."
    ...
    "Почти промурлыкала Славя. Да она, что, флиртует со мной?" #реакция типичного подростка на такой "флирт" (фактически, девушка - ровесница принижает и объявляет МУЖИКА слабеньким и ранимым) должна быть прямо противоположной желаемой. Славя могла бы и знать это. Если не знает - то, возможно, уместна была бы мысленная реплика ГГ о неумелости Слави и "будь на моём месте настоящий пацан семнадцати лет...". Дальнейшей реплики про "просто поскользнулся" маловато, кмк.
    ...
    "И она так же быстро растворилась в кустах. Какой-то ниндзя просто."
