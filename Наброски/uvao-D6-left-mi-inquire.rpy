...
# Черновик текста
#
# Использует флаг отказа Мику на пляже в Д2 alt_day2_mi_rejected
...
# сцена - муз.клуб изнутри днём.
    ...
    if not alt_day2_mi_rejected:
        "Изо всех сил стараясь делать вид, что прикосновение теплых нежных ладошек меня нисколько не смутило, я кивнул."
...
# сцена - ближняя тропинка в лесу.
    ...
    th "Могу себе представить такую \"беседу\". У Лены, должно быть, ангельское терпение."
...
# сцена - домик mi_un снаружи днём
 ...
 # сцена - домик mi_un изнутри днём
    ...
    if alt_day2_mi_rejected:
        "Кажется, предупреждения Шизы были не так уж беспочвенны - Мику окинула меня неожиданно холодным взглядом, но развивать тему не стала."
 ...
 # ЛБ: с благодарностью приму идеи сюжетов рисунков, подсмотренных Леной из "другой" жизни Сэма-дрища
    ...
    th "...что я знаю ещё одну особу, которая тоже осведомлена о моей жизни до... гм... совершения перехода, так это называется, кажется?"
    th "Во сне, говорит, тебя видела, в светящийся квадрат, говорит, пялился."
    dreamgirl "Подожди, ты что, всерьёз думаешь, что Лена тоже того... Визуализация?"
#    dreamgirl "Подожди, ты что, всерьёз думаешь, что Лена тоже того... Персонификация?" # ЛБ: Специально оба варианта термина - надо определяться
    th "Что? Нет, конечно же! {w} Хотя... {w} Да нет, ерунда. В конце концов, её местные знают, та же Алиса, например."
    th "Просто мне кажется, что между ними может быть какая-то связь, раз они обе про меня лишнее знают. Пожалуй, стоит мне поговорить с Юлей. Интуиция так подсказывает."
    ...
    th "Во всяком случае, других идей у меня нет. Так что сейчас я отнесу этот проклятый ящик, если, конечно, не умру раньше от изнеможения, и попробую хорошенько расспросить Юлю."
