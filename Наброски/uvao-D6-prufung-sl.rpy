label alt_day6_uvao_prufung_sl:
    ...
    dreamgirl "Встречайте - впервые на арене: типичный альфач, Семён «буйный психопат» Пурсунов."
    ...
    sl "Но как нам быть вместо, если завтра уже расстанемся? Ты ведь такой замкнутый - сам и не сделаешь первый шаг."
    ...
    sl "Да, Сёмушка."
         menu:
            "Я верю тебе.":
                ...
                sl "Не бойся, я никуда о тебя не сбегу и психом считать не буду."
                ...
                "Но вот теперь, рядом со мной человек, который не боится встать со мной рядом, вытягивая меня из бесконечно глубокой ямы собственного безразличия. Человек, готовый рискнуть разделить со мной все тяготы моего бесцельного существования."
