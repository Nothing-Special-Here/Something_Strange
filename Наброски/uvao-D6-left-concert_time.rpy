    ...
    me "А..."
    cs "Да, и непременно разыщи и приведи Лену!"
    me "Но как..."
    ...
    "Уловив намёк, я послушно проглотил все свои незаданные вопросы. Прикинул, в какой стороне находится спортплощадка, и опрометью бросился туда, преследуемый доносящимися со сцены финальными аккордами песни."
