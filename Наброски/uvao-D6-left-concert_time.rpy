...
label alt_day6_uvao_left_concert_time:
    ...
    "Тут со стороны сцены внезапно грянула музыка, разом заглушив шум, производимый десятками пионеров всех возрастов, и несколько детских голосов, вступив невпопад, затянули про \"солнечный круг, небо вокруг\"."
    hide un with dspr
