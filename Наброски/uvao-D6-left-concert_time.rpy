    ...
    "Рассказ получился на удивление коротким и скомканным. Хуже того, произнесённая вслух, вся эта история начала казаться мне самому довольно нелепой - мало ли кто в кого влюбляется по вполне естественным причинам? Так что, чем ближе я был к концу истории, тем глупее я себя чувствовал."
    ...
    "И тут меня осенило."
    me "Ольга Дмитриевна, если Вы позволите, то я догоню Вас буквально через пару секунд - если Вы не возражаете, конечно!" #ЛБ: возможно, слишком сильная стилизация под разговорный торопливый преувеличенно вежливый. Ленофаг: ага, перебор, кмк
