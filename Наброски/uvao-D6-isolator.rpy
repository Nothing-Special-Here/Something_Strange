...
label alt_day6_uvao_isolator_house:
    ...
    "Я не нашел, чем возразить, и просто уплетал обед за обе щеки. Славя присела на кушетку возле двери, с каким-то умилением глядя на меня."
    ...
    "Ощущение, проявившееся у меня в голове, больше всего походило на громогласное лошадиное ржание. Зарекшись еще хоть как-то реагировать на выходки внутреннего придурка, я прикончил обед и улыбнулся Славе."
    me "Очень вкусно! Спасибо тебе."
    sl "На здоровье! Хотя и не я готовила."
    "Сложив посуду, я помог Славе сложить их в авоську. Она повернулась, собираясь уходить…"
    sl "Семен…{w} А хочешь, я тебя выпущу?"
    ...
    menu:
        "Согласиться":
            ...
            "Славя рассмеялась."
            sl "Там все увидишь! Давай, выходи, мне уже пора возвращаться."
            th "Ну, хватит нерешительности. Пора действовать!"
            "Заперев пустой изолятор, мы вышли из медпункта. Сначала вышла Славя, и проверив, что рядом никого нет, махнула мне рукой."
            sl "Выходи, никого нет!"
            # Партизаним в лесах
            # Встречаемся с Юлей
            # Потом приходит Славя и толкает речь про то, что все ненастоящее, что это Семен все придумал, и он должен проснуться и взять ее с собой
