...
label alt_day6_uvao_isolator_house:
    ...
    "И вправду, в руках она держала авоську с металлическими посудинами. Из-под металлических крышек просачивался умопомрачительный запах. Я внезапно ощутил, насколько же я проголодался!"
    # звук урчания?
