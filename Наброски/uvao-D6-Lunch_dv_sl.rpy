    ...
    menu:
        "Сесть с Алисой":
            ...
            if alt_uvao_D4_lunch_un:
                ...
                dv "Я её хорошо знаю... Ну, вернее, как хорошо... Лучше других, во всяком случае. Мы живём недалеко и не первый год уже дружим."
...
#                "Поперхнувшись пловом, я отчаянно закашлялся и уставился на Алису сквозь выступившие слёзы."
            ...
            if alt_uvao_D6_CS_vetrov:
                ...
                #===== TODOtext
                #===== Алиса дуется, ГГ мыслит
            else:
                "Не сговариваясь, мы с Алисой поспешили разделаться со вторым, залпом выпили неизбежный компот и поспешили освободить помещение столовой."
