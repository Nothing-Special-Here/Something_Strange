...
# Возможно, нужно больше умных букв про состояние Шурика и причины оного. Всё-таки медик-научник.
    ...
    cs "Что же, это неплохая мысль. Пожалуй, так даже лучше будет, времени не так много осталось - завтра ведь последний день смены, ты в курсе?"
...
# Предъявляем ВЦ фотографию Юли и начинается умный разговор про визуализацию и аномалии.
# Уже без нервотрёпки по поводу ближайшего будущего.
# 
