...
# Здесь нужна рефлексия о том, как мало успелось и хочется ли возвращаться назад.
    ...
    if alt_day2_us_escape:
        ...
        "Виолетта недоумённо посмотрела на меня поверх очков, и я смущённо потупился." #ЛБ: уточнить про очки - кажется, она их давно сняла
...
# Чтобы отвлечься:
    ...
    cs "И изучать при этом особенно нечего - пока оборудование доставят, пока локализуют точку прокола… Впрочем, подробности тебе вряд ли интересны."
