...
# Здесь нужна рефлексия о том, как мало успелось и хочется ли возвращаться назад.
    ...
    if alt_day2_us_escape:
        ...
        "Мы, может, и рады были бы прицепить к составу вагон с мобильной лабораторией и собрать побольше информации, но ты же не удосужился о своём намерении прогуляться предупредить заранее, недели за три…{w} Впрочем, всё это сейчас несущественно."
...
# Чувствуем нарастающую панику - обратно тоскливо, здесь - ссыкотно
    ...
    "…Я вспомнил, как валялся в обмороке на полу домика вожатой в свой первый день здесь, и почувствовал, что краснею…" #ЛБ: По обморокам добавить вилку с учётом альт-Д1
    # if semen_panique: # Паника возле автобуса - выпилено автором!
    ...
    cs "И изучать при этом уже особенно нечего - пока оборудование доставят, пока локализуют точку прокола… Впрочем, подробности тебе вряд ли интересны."
    ...
    me "Тогда почему вы тогда были так уверены, что со мной ничего не произойдёт?"
