...
# тот же автобус...
	...
	cs "Вот скажи мне, Семён, неужели нельзя было без этого обойтись?"
	"Впрочем, увидев моё возмущённое лицо, Виола поспешила сменить гнев на милость:"
	cs "Ладно, ладно, не обижайся!{w} Я знаю, что ты здесь не при чём, просто если что-то мне и не нравится действительно в этой работе, так это вся эта писанина."
	"Она недовольно поморщилась - похоже, это действительно было для неё больной темой. Потом кивнула на монитор перед собой:"
