...
# Чтобы отвлечься:
    ...
    if alt_uvao_D6_CS_vetrov: # длинный разговор за чаем
        ...
        Виола говорила с неким нарочитым безразличием, однако я ощущал, насколько ей эта тема неприятна. Поэтому, я решил помочь ей, направив тему в нужное мне русло:"
