...
label alt_day6_uvao_getting_up:
    ...
    window show
# Сон Деимиурга-куна
# Странный сон мне приснился, будто я проснулся посреди какого-то лагеря.
# [6:22:02] Silver_Fang: Причем никогда в похожем месте не был.
# [6:24:46] Silver_Fang: Многого не упомнил, но из того что запомнил: странная девочка-брюнетка с короткой стрижкой и интересной куклой, которая выглядила как годовалый ребенок (девочка постояно доказывала всем что это кукла, отрывая ей голову), злючка-вожатка, которая принялась меня гнобить из-за всяких мелочек, ну и столовый бойкот (все время что я там провел, я дежурил в столовой ПСЖ и постоянно недокладывал вожатке жратвы в знак протеста
# [6:24:59] Silver_Fang: Ну и периодически подворовывал полдник...
# [6:26:22] Silver_Fang: Девочку было немного жалко, постоянно ходила одна, или сидела в сторонке и наблюдала за куклой, которая ходила сама по себе (никаких механизмов, обычная кукла)...
# [6:27:18] Silver_Fang: Я ее подкармливал ворованными булочками. Девочку всмысле...    if alt_uvao_true:
# Будит ОД
