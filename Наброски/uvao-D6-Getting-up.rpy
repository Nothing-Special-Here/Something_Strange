...
label alt_day6_uvao_morning_aidpost:
    ...
    dreamgirl "Ну если судить по словам и поведению вожатой, которая судя по всему боится данного явления до… гкхм… в общем сильно боится, то опасаться стоит и тебе."
    ...
    "Присев, я от нечего делать я стал рассматривать кабинет. Раньше как-то возможности не было. Весы, шкаф с лекарствами, пара кушеток, ничего необычного. На стене плакат с бодрой надписью, призывающей разводить овощи. Зачем он здесь?"
    ...
    cs "Можешь даже рубашку не снимать… пионэр."
    "А, нет, показалось."
    ...
    cs "Ты ведь помнишь, что случилось с Трофимовым? Боюсь, что подобный криз может повториться. И он будет повторяться всё чаще и чаще, пока психика данного субъекта не будет полностью разрушена."
    me "Что!?"
    "Я вскочил с кровати."
    ...
    me "Что же делать?"
    cs "Единственный известный мне способ, который позволит избежать воздействия, это полностью избегать контакта."
    ...
    cs "Я не хочу тебя пугать… но твоя кошкодевочка опасна. Очень опасна."
    ...
    dreamgirl "А что ты, собственно удивляешься, дружок? Ты сам-то, что – обычный пионер? Или ты из соседнего города приехал на летний отдых? Вот и я о том же."
    dreamgirl "Необычному пионеру – и отдых необычный."
    menu:
        "Поверить словам Виолы":
            th "Дыма без огня не бывает, как говорится. Наверное, мне действительно стоит послушаться их."
