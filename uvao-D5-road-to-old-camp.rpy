...
label alt_day5_road_to_old_camp:
    ...
    "Под ногу подвернулось что-то мягкое. Я взглянул туда."
    "Старый пыльный плюшевый медведь, без правой задней лапы, печально взирал на меня своим единственным глазом-пуговицей."
    "Возникало ощущение, будто я очутился в каком-то городе-призраке."
    "Осмотр первого этажа результатов не дал, поэтому я решил подняться на второй."
