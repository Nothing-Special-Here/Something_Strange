...
# Я напилил в фотошопе дневной вариант интерьера лагеря, решите использовать его или как. И, соответсвенно, может быть придётся немного под него переписать текст. - Ленофаг
# подпилил текст под CG от Ленофага. - Бегун
    "Я вошел в внутрь.{w} Там оказалось не так темно, как я ожидал. Солнечные лучи нет-нет, да и пробирались через дыры в потолке и разбитые окна."
