...
#
    ...
    "Шли мы не долго, несколько минут."
    "На пути я часто задумывался, из-за чего Юле приходилось меня ждать или постоянно окрикивать."
    "Я вспомнил что она сказала мне про Саныча и Ольгу Дмитриевну, как невольно начал хихикать."
    ...
    play ambience ambience_catacombs fadein 3
    window show
    "Пока я болтал с Шизой, Юля куда-то пропала, а под моими ногами красовалась огромная дыра, в которой я ни черта не видел."
    uv "Давай сюда."
    "Её голос донёсся откуда-то снизу. Наверное, пока я был занят столь увлекательным диалогом с самим-собой, она уже спрыгнула."
...
#
    ...
    "Мы продолжили преследование, и через пару минут увидели тот самый выход - обвалившийся потолок тоннеля, выводящий на поверхность где-то посреди леса. Я прикинул высоту - до поверхноси где-то метра три."
