...
#
    ...
    me "Идём скорее!"
    # надо менять перекрёстки под звуки топота и дыхания, с раскачиванием влево-вправо.
    # Сделано, почти. Звук дыхания и шагов находятся на одном канале(sound_loop), вместе их воспроизвести нельзя. Предложения?
    window hide
    ...
    show sh angry bar3 far at fright
