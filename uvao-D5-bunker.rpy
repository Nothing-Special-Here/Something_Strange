...
#
    ...
    menu:
        "Проигнорировать":
            ...
            #"Она удивлялась моему поведению так искренне, как умеют удивляться только дети. И эта её реакция пробудила во мне новую волну неконтролируемого смеха."
            #"От которого даже немного начало крутить в животе."
...
#    "Я оглядел бункер, но ничего способного мне помочь, не нашёл."
    uv "Так мы туда пойдём? Там туннель. Я там часто хожу."
    me "Ну, ладно. Пошли."
...
#
    ...
    "На пути я часто задумывался, из-за чего Юли приходилось меня ждать или постоянно окрикивать."
    ...
    th "Виола и на \"{i}пионэрах{/i}\" неплохо отрывается. Хотя и это тоже не исключено."
    window hide
    ...
    dreamgirl "А она быстро учится, только смотри её плохому не научи."
    ...
    if alt_uvao_D5_sleep:
        ...
        th "Я догадывался кто это может быть."
