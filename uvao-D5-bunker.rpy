...
#
    ...
    if alt_uvao_D5_hentai:
        "Зацени - встретил кошкодевочку, приманил плюшками, завёл в бомбоубежище и отодрал так, что шерсть дыбом. Одно слово - педозоофил!"
    ...
    if alt_uvao_D5_hentai:
        ...
        "Стараясь не шуметь, я начал одеваться, изредка поглядывая на спящее тело девушки."
