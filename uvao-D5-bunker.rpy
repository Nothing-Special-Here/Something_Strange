...
#
    # TODO: Спрайты и музыка.
    dreamgirl "Что делать-то будем? Юля уже почти все конфеты съела, сейчас последнюю дожует и опять за тебя примется."
    ...
    dreamgirl "А то! Она в этом деле мастер.{w} Кстати, ты не задумывался, а вдруг тебя сюда завезли как подопытный организм для разработки боевого вируса, передающегося половым путем?"
    ...
    uv "Обед - это хорошо, вкусно. Принеси мне потом еще булочек!"
    me "Принесу, принесу, сдобная душа. Ты только меня проведи обратно, чтоб никто не заметил."
    uv "Это нужно под землей идти. Там никто не заметит! Пошли!"
    "Она направилась было к той двери, через которую мы вошли, но вдруг остановилась."
    uv "А вот эту дверь ты можешь открыть?"
    "Она указала на вторую такую же, но более заржавленую. Видно было, что ее открывают гораздо реже, чем первую… Хотелось бы знать, кто именно, и зачем?"
    me "Попробую."
    "Затвор был в точности такой же, как и у первой двери. Указав Юле на кнопку, я приготовился крутить штурвал."
    # звук-скрежет
    "Механизм шел туже, чем у первой двери, но все же скоро перед нам распахнулся точно такой же бетонный туннель."
    jump alt_day5_uvao_mines_begin
