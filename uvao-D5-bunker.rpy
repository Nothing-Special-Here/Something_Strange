...
#
    ...
    #у нас есть звук чирканья спички?
    ...
    show uv smile at center with dspr
    "Она усмехнулась."
    uv "Я тебя поведу. За ла…, ой, то за руку."
    ...
    if alt_uvao_D5_sh_mines:
        ...
        uv "Направо."
        "Я покорно следовал за моим всевидящим спутником. Да и что мне оставалось, в темноте я всё-равно ничего не вижу, а тратить спички мне уже давно надоело."
...
#
    ...
    #получится сделать затемнение, с подсветкой какого-нибудь угла ЦГ?
    ...
    "Вскоре мы подобрались достаточно близко, чтобы выглянуть из-за камнейю"
    window hide
    scene cg d4_sh_sit
    window show
