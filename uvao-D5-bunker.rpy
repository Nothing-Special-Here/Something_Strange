...
#    "Почему-то я решил не выдаваться в сравнительный анализ коитуса грызунов и людей."
    ...
    if alt_uvao_true:
        ...
        dreamgirl "А я и не говорил, что это нормально. Ты думаешь Виола просто так попросила кошечку твою сфотографировать? Но, честно сказать, это для меня тоже сюрприз."
