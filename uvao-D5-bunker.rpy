...
#
# Используется флаг alt_uvao_D5_hentai для выдачи фраз о том самом
#
    ...
    "Скосив глаза, я присмотрелся к голове, лежащей у меня на плече. Уши как уши, обычные кошачьи. Вот только растут из человека… И хвост. "
    if alt_uvao_D5_hentai:
        extend "Я прикрыл глаза, вспоминая недавние события. "
    ...
    th "Отстань, я сказал."
    dreamgirl "Я-то отстану. "
    if alt_uvao_D5_hentai:
        extend "Но если вдруг через 9 месяцев окрестные леса заполонят похожие на тебя котята… Мы оба будем знать, кто из нас виноват."
    else:
        extend "Да вот только это не я сейчас лежу на кровати с девочкой, которая на половину как кошка выглядит."
    ...
    th "Мне?!"
    dreamgirl "Ну не мне же. Я тут сижу и угораю, глядя на происходящее."
    if alt_uvao_D5_hentai:
        extend "Зацени - встретил кошкодевочку, приманил плюшками, завёл в бомбоубежище и отодрал так, что шерсть дыбом. Одно слово - зоофил!"
    ...
    "Юля по-прежнему сопела, лёжа на моем уже затёкшем плече. "
    if alt_uvao_D5_hentai:
        extend "Без одежды было неуютно, но встать я не мог. "
    else:
        extend "Мне становилось уже немного не удобно, но встать я не мог. "
    extend "Кто знает, как она отреагирует на внезапное пробуждение?"
    "Я взглянул на неё."
    ...
    if alt_uvao_D5_hentai:
        ...
        "Стараясь не шуметь, я начал одеваться, изредка поглядывая на спящую девушку."
    ...
    if alt_uvao_D5_hentai:
        ...
        uv "Хочешь я тебе кое-что покажу?"
        #TODO: Текст
        "Или поменять ещё на что-то"
    "Юля ткнула пальчиком в сторону ещё одной железной двери."
    uv "Только она тоже не открывается."
    me "Ничего, сейчас что-нибудь придумаем."
    "За разговором мне удалось-таки повязать себе несчастный галстук."
