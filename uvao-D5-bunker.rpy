...
#Д5 - Расспросы Юли
#
    # TODO: спрайты, мысли между строк
    # Не знаю, какую лучше
    play music music_list["trapped_in_dreams"] fadein 3
    #play music music_list["she_is_kind"] fadein 3
    th "Поиск улик не принес результатов. Следовательно, стоит сосредоточиться на допросе свидетелей.{w} Тем более что вот он, свидетель, шуршит конфетами."
    ...
    th "Мда, так мы никуда не придем."
    me "Ну вот смотри. Я - Семен."
    uv "Да, я знаю."
    ...
    me "Ну, это… Неважно, в общем, я тебе потом как-нибудь расскажу. Ты мне лучше скажи - я вот идти не хотел… а потом взял - и пришел?"
    uv "Ага, не хотел, не хотел, а потом пришел."
    me "А как это? Как это так вдруг получилось?"
    uv "Обычно. Взял - и пришел. Приехал. Тут очутился."
    ...
    uv "Не кричи! Просто взял и пришел. Ты давно уже должен был прийти, только все не хотел и не хотел. Я уже даже ждать устала."
    me "Так, получается, это ты мне снилась и спрашивала - \"Ты пойдешь со мной?\""
    show uv normal close with dspr
    uv "Не знаю. Это же тебе снилось, а не мне. Я просто ждала, когда ты наконец придешь."
    ...
    uv "Давно. Всегда. Тут еще дети жили, маленькие, в старом лагере. Потом все в новом лагере стали жить, а я здесь. Наверно, их та вожатая испугала."
    me "Вожатая? Испугала?"
    ...
    #show uv dontlike или show uv rage
    me "Ну ладно. Тогда расскажи лучше, что это за ходы тут такие под землей?"
    uv "Очень интересные ходы! Длинные! Там дальше еще дыра есть вниз, в другие ходы. Я в них живу и припасы храню. А теперь, когда ты мне дверь открыл, я буду здесь жить, здесь кровать удобная."
    ...
    uv "Знаю. Надо вниз спуститься, и оттуда можно прямо к Генде выйти. Под землей.{w} А если ты вон ту дверь тоже откроешь - то будет еще быстрее."
...
#
    ...
    "Я вспомнил что она сказала мне про Саныча и Ольгу Дмитриевну и невольно начал хихикать."
    ...
    "Шиза снова не упустила повод меня подколоть, но я решил проигнорировать её выпад."
    if alt_uvao_D5_sh_mines:
        ...
        "Грозно сказал я, притопнув ногой."
...
#
    ...
    sh "… Пришел… {w}А тут пусто… {w}Они говорили - налево… направо…{w} Куда вели?…{w} Я правильно шел…{w} И никого…{w} Надо искать…{w} Она где-то здесь…{w} Тогда поверят…"
