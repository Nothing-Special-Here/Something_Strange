...
#
    ...
    dreamgirl "Оружейный, балда! Подкрадись и выясни."
    ...
    th "Да он псих! Черт, и что же с ним теперь делать? Нельзя же его тут оставить!"
    #Пугаем его, выманиваем на отряд.
    return
    #jump событие_с_отрядом
    
    #Лейбл событие с отрядом. Мыслей - набросков кусок.
    #th"Надо как-то увести его отсюда. Но как?"
    #dreamgirl"Может, оглушить его? А потом как мешок картошки вынести."
    #dreamgirl "Хлороформ бы для этого идеально подошёл. Подкрался бы сейчас к нему со спины, спросил бы про библиотеку."
    #th"В бункере?! Идиот!"
    #th"Да и не очень хочется мне к нему подходить. Он, кажись, тронулся. Да и вообще, даже если удастся его оглушить, как я его понесу потом?"
    #dreamgirl"Твоя правда. Хотя… есть тут у меня ещё пара мыслей."
    #th"Огласите весь список вариантов, пожалуйста!" - Ленофаг
