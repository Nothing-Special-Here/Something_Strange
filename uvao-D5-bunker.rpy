...
# пред-хентай...
    ...
    dreamgirl "И улеглась она на тебя просто так, ага.{w} Поверь мне, если её перестанет устраивать происходящее, тебе об этом сообщат. В виде огромных царапин на всю щёку. Ну или пощёчину влепит, если ей хоть немного понравилось."
    if alt_uvao_true:
...
#
    ...
    with dissolve
    window show
    "Скатившись по насыпи в шахту и отряхнув шорты, майку и всё остальное, я разглядел в темноте силуэт Юли. Нежные пальцы обвили мою ладонь и легко потащили за собой."
