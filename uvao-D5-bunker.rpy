...
#    "Почему-то я решил не выдаваться в сравнительный анализ коитуса грызунов и людей."
    ...
    if alt_uvao_true:
        ...
        "Я открыл рюкзак, достал конфеты, и, уже хотел закрыть его, как заметил, что под конфетами лежали спички."
        ...
        "Я решил прилечь и подождать, пока моя нога пройдёт. {w}"
        stop music fadeout 3
        menu:
...
#
    ...
    if alt_uvao_D5_hentai:
        ...
        "Разговоры с Шизой, никогда не упускавшей случая чтобы подшутить надо мной, стали меня конкретно раздражать."
