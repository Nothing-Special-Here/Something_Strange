...
#
    ...
    "Мы по немногу привыкли к солнечному свету, как вдруг с улицы раздался чей-то крик."
...
#
    ...
    with dissolve
    window show
    "Пришли мы к какому-то подобию шахтёрского привала. Слева на стенке висели старые фонари, которые назывались в честь какого-то ночного животного."
    ...
    uv "Сюда."
    "Тем временем Юля, наверное, открыла ту самую дверь, и ожидала меня. Не медля я пошёл в её сторону."
    window hide
