...
# А вот ни фига, люк не в холле, а в кабинете начальника, как в Мику-руте (alt_mi_route.rpy)
# И это ж-ж-ж неспроста!
    ...
    uv "А никуда. Подождём здесь, пока этот твой Шурик уйдёт, и вернёмся."
    ...
    uv "Ой, правильно! Пойдём, попробуем открыть! И скучно не будет!"
    ...
    th "Интересно, что это такое? Спуск в бомбоубежище?"
    ...
    "В жёлтоватом свете пыльной лампы хорошо были видно, что стенам уже не один десяток лет, но время практически не коснулось их - ни трещин, ни потёков воды."
    ...
    "Немного пошаря глазами по сторонам я заметил кусок толстой арматуры."
    th "Хмм, а что если?…"
    "Подобрав свою находку, я вставил её в колесо кремальеры."
    me "Дайте мне точку опоры, иииии…"
    "И ни хрена. Я надавил ещё сильнее, потом навалился всем телом, надеясь таки сдвинуть заржавевший механизм. Тщетно."
...
# звук скрежета
    ...
    "Шипя от боли, я выкрутил колесо до упора и потянул.[w} Дверь очень неторопливо провернулась на петлях."
    me "Похоже, что да."
...
# он же в шортах
    ...
    dreamgirl "Инвалидом ты бы стал, если бы с разбитым суставом выбрался отсюда! А до тех пор ты был бы пропавшим без вести."
    uv "Залижи."
    me "A?"
    ...
    "Последнее что я почувствовал - как кто-то теплый подлез мне под руку и улегся рядом…"
...
#    "Она взяла мои руки и положила себе на спину. Опа, а куда это ее платье подевалось?"
    ...
    dreamgirl "И улеглась она на тебя просто так, ага.{w} Поверь мне, если ее перестанет устраивать происходящее, тебе об этом сообщат. В виде огромных царапин на всю щёку. Ну или пощёчину влепит, если ей хоть немного понравилось."
    if alt_uvao_true:
...
#    "Почему-то я решил не выдаваться в сравнительный анализ коитуса грызунов и людей."
    ...
    "Юля, всё ещё лежала на мне и изучюще смотрела в лицо. Чёрт, да на ней из одежды только лишь эта пародия на платье!"
...
label alt_day5_uvao_mines_begin:
    ...
    "Я вспомнил что она сказала мне про Саныча и Ольгу Дмитриевну, как сразу начал не громко хихикать."
    ...
    th "Ночь, полная луна и пляж сделали свою работу на отлично."
    ...
    if alt_uvao_D5_hentai:
        ...
        dreamgirl "Хотя бы вспомнил как это делается. Не стыдно было бы перед другими пионерками в будущем."
        "Разговоры с Шизой, как со старшим братом, который не упустит момент и не подшутит надо мной, стали меня конкретно раздражать."
    ...
    if alt_uvao_D5_sleep:
        ...
        th "Похоже, это означает, что я не ошибся. Хотя погодите. \"Друг\"?"
