...
label alt_day5_getting_up:
    ...
    if alt_day4_uv_viola_evening:
        ...
        "Надо мной нависало недовольное лицо Одьги."
        ...
        mt "…А тебе в старый корпус, контакт устанавливать."
...
#Необходим кошерный сигнал будильника-в-телефоне. Наверное, надо отрезать звонок от sfx_hell_alarm_clock, и пустить это дело в music.queue - сначала sfx_hell_alarm_clock, потом много-много трелей собственно звонка.
    ...
    window show
    "Расудив, что спешка - отличный повод избежать ежедневного аттракциона с умыванием ледяной водой, я ограничился посещением гостепреимного домика с буквами «М» и «Ж» на боковой стене."
    window hide
    scene bg ext_houses_sunset with dissolve
    window show
    "Минут через десять я уже шёл мимо последних домиков в дальнем конце лагеря."
