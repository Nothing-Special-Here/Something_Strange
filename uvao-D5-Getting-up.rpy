...
label alt_day5_getting_up:
    ...
    if alt_day4_uv_viola_evening:
        ...
        #Встаём сами
#Необходим кошерный сигнал будильника-в-телефоне. Наверное, надо отрезать звонок от sfx_hell_alarm_clock, и пустить это дело в music.queue - сначала sfx_hell_alarm_clock, потом много-много трелей собственно звонка.
        play sound_loop sfx_home_phone_ring fadein 1
        "Проснулся я от мерзкого звука встроенного в телефон будильника."
        "Не открывая глаз, привычно потянулся было вправо, чтобы добраться до стола и заткнуть это голосистое чудовище{w}… И уткнулся носом в стену!"
        th "Что?…"
        "Через пару секунд до меня дошло, что я же не дома!"
        stop sound_loop fadeout 1
        "Я спустил ноги с кровати и выключил наконец будильник."
        "Потряс головой, прогоняя остатки сна и попытался сфокусировать взгляд на экране. «6:46»"
...
#Бегун: Всё проще, он поставил на 6:45, но у него ушла минута, чтобы проснуться и продрать глаза. Можно и больше, кстати :)
    ...
    "Расудив, что спешка - отличный повод избежать ежедневного аттракциона с умыванием ледяной водой, я ограничился посещением гостепреимного домика с трафаретом «МЖ» на боковой стене."
    window hide
