...
# Пляж в Д3-волейбол гарантированно не посещали, плавок у ГГ нет - проверено. (ЛБ)
    ...
    th "Знаешь, я-то бы как раз предпочёл быть как все и не выделяться."
...
#    else:
    ...
    "Поймав мой взгляд, Алиса на секунду нахмурилась было, но вдруг самодовольно ухмыльнулась и, не отводя глаз, повернулась вполоборота."
