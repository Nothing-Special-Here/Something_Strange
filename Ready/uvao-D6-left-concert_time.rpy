...
# /пока что задаём сцену на время отладки
    ...
    me "Спасибо!"
    "Мрачно пропыхтел я вслух, прикрывая лицо от хлещущих ветвей и пытаясь понять, зачем вообще я, как лось, ломлюсь через эти проклятые кусты вместо того, чтобы добраться до спортплощадки по дорожке, сделав небольшой крюк?"
    ...
    "Мне повезло - на дальнем конце футбольного поля я заметил две яростно жестикулирующие фигуры. Я облегчённо перевёл дух и затрусил к ним."
