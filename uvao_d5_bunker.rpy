label alt_day5_uv_bunker:
    ...
    play music music_list["orchid"] fadein 5# Вообще его вставить надо по приходу в бункер \ лагерь. Мы же тут первый раз.
    ...
    menu:
        ...
        "Узнать поподробней":
            ...
            uv "Ааа. Тогда ладно."
            "Она взяла мою ладонь и положила себе на голову. Вне гласно намекая - гладь давай, не отвлекайся!"
            ...
            menu:
                "Проигнорировать":
                    "Шиза всё-ещё привлечь моё внимание, однако ни сил ни желания разговаривать с ним не было, и я, сам этого не замечая, провалился в сон."
                    ...
                    th "Не хватало что-бы меня ещё вот-так застукали"
                    ...
                    show uv guility close at center with dspr
                    
                    uv "Ай... {w}Больно."
                    "Ударившись, она резко плюхнулась на меня."
                    ...
                    "В её голосе были нотки недовольства, однако после этой фразочки она и сама хихикнула пару раз и встала с кровати. В этот раз без происшествий."
                    
                    show uv smile close at center with dspr
                    
                    #Дальше они идут в тоннель, там шурик, потом отряд и много много всего, и I NEED SOME HEEEELP
                    
                    
                    #Лишний, не сюжетный кусок, но пусть висит до релиза, может пригодится
                    """
                    hide uv
                    
                    uv "Это человек только что приходил. Из лагеря."
                    "Сквозь сон сказала она. Я не обратил внимания."
                    "Юля всё-ещё лежала на кровати, и, похоже, любовалась тем как я одевался. Сама одеваться она, похоже, не торопилась."
                    me "Вставай, Кисонька, я ещё на обед успеть хочу..."
                    dreamgirl "Ты что делаешь, ирод. Она же тебя сейчас за самого настоящего эгоиста примет. Секс есть, можно и поесть можно, ага."
                    me "...да и вдруг тот придурок, что ломился сюда, придёт ещё раз, с чем-нибудь по серьёзнее."
                    "Моментально попытался сменить тему я."
                    
                    show uv normal at center with dspr
                    
                    uv "Он уже ушёл. Далеко."
                    me "Откуда ты знаешь?"
                    uv "Не знаю."
                    dreamgirl "Ну да, типичная девушка."
                    "С Шизой я был согласен на все сто."
                    uv "Я просто чувствую это. Да и топает он громко."
                    
                    show uv smile at center with dspr
                    
                    "Она так мило по дёргала своими ушками, что я даже залип на каких-то пару секунд."
                    uv "Этот тот самый, с очками."
                    "Наверное, что-бы прервать мой ступор сказала она."
                    
                    show uv normal at center with dspr
                    
                    "Повалявшись ещё минутку Юля нехотя встала с кровати и накинула на себя свою нехитрую одежду."
                    me "И как выбираться будем?"
                    """
                    #Конец куска
                "Побеседовать с Шизой":
                    "Судя по монотонному сопению девушки, та явно уснула. Все-таки есть в ней что-то человеческое…"
                    "Ко мне же сон не шёл. Мысли ураганом носились в моей голове."
            ...
            uv "Налево."
            "Я покорно следовал за моим всевидящим спутником. Шли мы недолго, минут пять-десять."
            ...
            #Надо добавить больше описания. У нас фоны каждую 3ую фразу сменяются.
            ...
            "Юля осмотрела комнату, нырнула за большую трубу, по копошилась немного и вынырнула прямо под свет. Она забралась по лестнице к решётке в потолке, немного поковыряла в замке и спустилась вниз."
