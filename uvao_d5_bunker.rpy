...
label alt_day5_uv_hentai:
    ...
    "С Шизой говорить желания не было, однако она не оставлял попытки докопаться до меня."
...
label alt_day5_uv_mines_begin:
    ...
    #Ленофаг: Если дверь не открывается, откуда Юле знать, куда она ведёт и тем более, что тоннель выходит на площадь?
    me "А куда она ведёт?"
