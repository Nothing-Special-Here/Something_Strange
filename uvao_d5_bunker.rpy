label alt_day5_uv_bunker:
    ...
    "При ударе я, похоже, не расчитал силу, вследствие чего по моему правому колену неприятной волной прокатились несколько сотен иголок."
        ...
        "Узнать поподробней":
            ...
            menu:
                ...
                "Побеседовать с Шизой":
                    ...
                    dreamgirl "Конечно, не мне тебя воспитывать, но стоит лишь взглянуть на ее уши и хвост… Вобщем, зоофилией попахивает, дорогой."
