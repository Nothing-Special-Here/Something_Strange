...
label alt_day5_uvao_hentai_scene:
    ...
    menu:
        "Проигнорировать":
            ...
            # "Пропускать его совсем не хотелось, так что я поспешил подняться и поскорее одеться." - альт. вариант от Ленофага
...
label alt_day5_uvao_mines_sh:
    ...
    #"Мои глаза понемногу стали привыкать к темноте, и я стал хоть немного различать силуэты вокруг."
    #Мы доходим, вспоминаем про спички, осматриваемся
    window hide
...
label alt_day5_uvao_from_mines_to_dinner:
    ...
    "Пока мы ходили в полной темноте - я уже начинал чувствовать себя слепым."
    ...
    "Пару мгновений глаза привыкали к свету, но потом я наконец смог осмотреться."
    ...
    "Впрочем, Шиза иногда был даже полезен."
