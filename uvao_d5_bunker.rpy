...
#    "Я оглядел бункер, но ничего способного мне помочь, не нашёл."
    uv "Так мы туда пойдем? Там туннель. Я там часто хожу."
    me "Ну, ладно. Пошли."
...
label alt_day5_uvao_mines_begin:
    ...
    "Шиза снова не упустила повод меня подколоть. Я решил проигнорировать её выпад."
    window hide
    scene bg int_mine_crossroad
    show uv normal at center
    with dissolve
    ...
    if alt_uvao_D5_sleep:
        ...
        uv "Ой, да, прости."
        uv "Он где-то с левой стороны, пошли скорее."
