...
#    "Почему-то я решил не выдаваться в сравнительный анализ коитуса грызунов и людей."
    ...
    if alt_uvao_true:
        ...
        "Я открыл рюкзак и вытащил оттуда подарок \"родителей\". Юля радостно заулыбалась. Судя по её реакции, вкусная еда для неё всегда на первом месте."
...
label alt_day5_uvao_mines_begin:
    ...
    if alt_uvao_D5_sleep:
        ...
        uv "Ой, да, прости."
        uv "Он где-то там."
        "Я услышал взмах. Наверное она показала в какую-то сторону своей лапкой, да вот только я ничего не видел."
        uv "Пошли."
...
label alt_day5_uvao_from_mines_to_dinner:
    ...
    "Пока мы ходили в полной темноте - мои глаза немного привыкли, и я смутно мог различать силуэты различных предметов вокруг себя."
