...
label alt_uvao_D5_hentai_scene:
    ...
    menu:
        "Проигнорировать":
            ...
            "Покончив с формальностями и проводив кошечек до лимузина, я вернулся в кабинет. Неплохой куш нам сегодня обломился! Я подмигнул Юрию Куклачеву, грозящему мне пальцем из фоторамки на столе, вытянулся в удобном кресле и прикрыл глаза."
