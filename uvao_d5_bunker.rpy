label alt_day5_uvao_bunker:
    ...
    $ alt_uvao_D4_supper_cs = False # Будем считать, что она не предупредила за ужином.
...
label alt_day5_uvao_evade_hentai_scene:
    ...
    "Юля, всё ещё лежала на мне и изучала меня. Чёрт, да она же голая!"
    ...
    if alt_uvao_D4_supper_cs:
        ...
        "Шкафчики с разными необходимыми припасами. Противогазы, аптечки с описью, инструменты… О, фонарик! Пригодится, если придется еще блуждать по подземельям."
    menu:
