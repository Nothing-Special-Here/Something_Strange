...
# он же в шортах
    "Я решил посмотреть, что с ногой. На коленке красовалась небольшая ссадина поверх наивающегося синяка."
...
#    "Почему-то я решил не выдаваться в сравнительный анализ коитуса грызунов и людей."
    ...
    "Юля всё ещё лежала на мне и изучающе смотрела в лицо. Чёрт, да на ней из одежды только лишь эта пародия на платье!"
...
label alt_day5_uvao_mines_begin:
    ...
    if alt_uvao_D5_hentai:
        ...
        dreamgirl "Вспомнил как это делается, для приличия, чтобы не облажался перед другими пионерками в будущем."
    ...
    window show
    uv "Налево."
    "Так мы и ходили. То направо, то налево. Я не знаю, зачем она каждый раз говорила, куда мы поворачиваем, но мне и не особо хотелось."
    "Может быть, она хотела поговорить о чём-то, но я просто молчал и плёлся за ней."
    window hide
    scene bg int_mine_crossroad
    show uv normal at center
    with dissolve
