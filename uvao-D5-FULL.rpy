...
######### Так же, напоминаю, что scenario_uvao_debug #########
...
label alt_day5_uvao_mines_sh:
    ...
    "Я уже собрался было выскочить на подмогу, отлично понимая уже, что не успею, но… В последний момент Лена пришла в себя и отскочила в сторону."
