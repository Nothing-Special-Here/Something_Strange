...
label alt_day5_uvao_evade_hentai_scene:
    ...
    if alt_uvao_true:
        ...
        "Кажется, для меня блестнул луч надежды. Я судорожно превёл дыхание."
        ...
        "Не долго думая, я сунул коробок в карман шорт и покосился на Юлю. Та увлечённо боролась с конфетами, не обращая на меня особого внимания."
        ...
        "Мелькнула было мысль понажимать кнопки и повертеть ручки, что называется, \"от балды\", но я решил не искушать судьбу. Мало ли, еще спалю что-нибудь."
...
label alt_day5_uvao_mines_begin:
    ...
    if alt_uvao_D5_hentai:
        ...
        hide uv with dissolve
        "Углубившись в воспоминания, я не сразу заметил, что Юля куда-то пропала."
    ...
    "Впрочем, с учётом того, что мой Вергилий ждал меня где-то внизу, выбора особого у меня не было."
