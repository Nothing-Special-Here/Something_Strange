...
label alt_day5_uvao_hentai_dress_up:
    ...
    uv "Так мы туда пойдём? В тоннель?"
    me "Ну, ладно. Пошли."
    jump alt_day5_uvao_mines_begin
...
label alt_day5_uvao_mines_begin:
    ...
    with dissolve
    window show
    "За дверью оказался тоннель, очень похожий на тот, по которому пришли сюда. Юля проворно выбралась за мной и с любопытством осмотрелась."
...
label alt_day5_uvao_mines_sh_capture_debug: #Хомутаем Шурика и отлаживаем спрайты
    ...
    th "И как они теперь будут его искать? Ещё нас заметят, чего доброго. Наверное, придётся нам снова прятаться в тоннелях, или в бункере…"
    if alt_uvao_D5_hentai:
