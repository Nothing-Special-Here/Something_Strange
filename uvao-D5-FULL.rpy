########################### ВНИМАНИЕ!!! ######################
# Для Корректной работы удалите все одиночные файлы 5го дня! #
##############################################################
...
label alt_day5_uvao_evening:
    ...
    if (alt_uvao_D5_sh_mines):
        ...
        if alt_uvao_D4_viola_morning:
            ...
            th "Странно… При чём здесь медсестра? Я не ранен, не считая почти зажившего синяка на колене, а раз Ольга сама видела Юлю, то понимает, что с головой у меня всё в порядке…"
